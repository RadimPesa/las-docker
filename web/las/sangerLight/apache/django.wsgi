...
sys.path.append('/srv/www/sangerLight/')
...
import sangerLight.settings
import django.core.handlers.wsgi
_application = django.core.handlers.wsgi.WSGIHandler()
def application(environ, start_response):
    #print '*** SUBSITE URL = ' + environ['SCRIPT_NAME'] + ' ***'
    sangerLight.settings.LOGIN_URL = environ['SCRIPT_NAME'] + sangerLight.settings.LOGIN_URL
    sangerLight.settings.BASE_URL = environ['SCRIPT_NAME']
