...
DB_NAME = 'sanger'
DB_USERNAME = 'sangerusr'
DB_PASSWORD = 'sangerpwd2013'
DB_HOST='lasmysql'
...
MEDIA_ROOT = path.join(BASEDIR, 'sangerApp/sanger_media/')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = '/sanger_media/'
...
TEMP_URL = path.join(BASEDIR,'sangerApp/sanger_media/tmp/')
...
MIDDLEWARE_CLASSES = (
    ...
    'sangerApp.middleware.AjaxRedirect',
...
ROOT_URLCONF = 'sangerLight.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sangerLight.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = ('django.contrib.auth.context_processors.auth',
                                ...
                                'sangerApp.context_processor.custom_context_processor',
)
...
CSRF_COOKIE_PATH = '/sanger'
SESSION_COOKIE_PATH = '/sanger'
