...
os.environ['DJANGO_SETTINGS_MODULE'] = 'uarray.settings'

# Activate your virtual env
activate_env=os.path.expanduser("/virtualenvs/venvdj1.4/bin/activate_this.py")
execfile(activate_env, dict(__file__=activate_env))

import uarray.settings
import django.core.handlers.wsgi
_application = django.core.handlers.wsgi.WSGIHandler()
def application(environ, start_response):
    #print '*** SUBSITE URL = ' + environ['SCRIPT_NAME'] + ' ***'
    uarray.settings.LOGIN_URL = environ['SCRIPT_NAME'] + uarray.settings.LOGIN_URL
    uarray.settings.BASE_URL = environ['SCRIPT_NAME'] 
