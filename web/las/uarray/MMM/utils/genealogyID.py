...
class GenealogyID ():
    ...
    def setOrigin(self, o):
        if len(o) == self._indexes['origin'][1]-self._indexes['origin'][0]:
    ...
    def setSampleVector(self, v):
        if len(v) == self._indexes['sampleVector'][1]-self._indexes['sampleVector'][0]:
    ...
    def setTissueType(self, t):
        if len(t) == self._indexes['tissueType'][1]-self._indexes['tissueType'][0]:
    ...
    def _setArchivedMaterial (self):
        if self._genID[self._indexes['archiveMaterial2'][0]:self._indexes['archiveMaterial2'][0]+self._indexes['archiveMaterial2'][1]] == '00' or self._genID[self._indexes['archiveMaterial2'][0]:self._indexes['archiveMaterial2'][0]+self._indexes['archiveMaterial2'][1]] == '--':
...
def main():
    ...
    g.updateGenID({'2derivation':'D','2derivationGen':'04'})
    print g.getGenID()
