...
function generate_table(){
    ...
    jQuery(document).on ('click',"#plan_table tbody td span.ui-icon-closethick", function(event) {
        var nTr = jQuery(this).parents('tr')[0];
        var idplan = jQuery(nTr).attr('plan_index');
        var operator = jQuery('#user_name').attr('user');
        var response = {'idplan': idplan, 'operator':operator};
