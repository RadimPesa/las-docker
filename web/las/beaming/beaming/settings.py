# Django settings for beaming project.
from os import path
import os
...
DB_NAME = 'beaming'
DB_USERNAME = 'beamingusr'
DB_PASSWORD = 'beamingpwd2013'
DB_HOST='lasmysql'
...
MEDIA_ROOT = path.join(BASEDIR, 'biopsy/biopsy_media/')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = '/biopsy_media/'
...
TEMP_URL = path.join(BASEDIR,'biopsy/biopsy_media/tmp/')
...
MIDDLEWARE_CLASSES = (
    ...
    'biopsy.middleware.AjaxRedirect',
...
ROOT_URLCONF = 'beaming.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'beaming.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = ('django.core.context_processors.request',
                                ...
                                'biopsy.context_processor.custom_context_processor',
...
CSRF_COOKIE_PATH = '/liqbiopsy'
SESSION_COOKIE_PATH = '/liqbiopsy'
