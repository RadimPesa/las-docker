...
os.environ['DJANGO_SETTINGS_MODULE'] = 'beaming.settings'
...
def application(environ, start_response):
    ...
    beaming.settings.LOGIN_URL = environ['SCRIPT_NAME'] + beaming.settings.LOGIN_URL
    beaming.settings.BASE_URL = environ['SCRIPT_NAME'] 
