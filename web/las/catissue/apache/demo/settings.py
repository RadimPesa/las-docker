...
MEDIA_ROOT = '/srv/www/catissue/tissue/tissue_media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = '/demo/tissue/tissue_media/'
...
SECRET_KEY = '4pO(_<w0>tyW&T3>VE+i2`.[a[ElI8V#@x+gIpf$s=0^6U!R0+tX2MzjOJc/=u_y'
...
AUTH_SECRET_KEY ='w[2I}-AXRzL<~_AEGaiV[E0= M H}!fzOs-#,Vyg6t7quR1O|_535-4y_,(WS[C.'
...
HOST_URL= '/demo/biobank'
HUB_URL=''

SESSION_ENGINE = 'django.contrib.sessions.backends.db'

CSRF_COOKIE_PATH = '/demo/biobank'
SESSION_COOKIE_PATH = '/demo/biobank'
