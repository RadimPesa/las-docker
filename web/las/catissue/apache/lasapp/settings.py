...
DB_NAME='biobanca2'
DB_USERNAME='biobankusr2'
DB_PASSWORD='biobankpwd2013'
...
#LAS_URL = 'https://lasapp.polito.it/las/'
...
#LAS_AUTH_SERVER_URL ='https://lasapp.polito.it/las/laslogin/'
LAS_AUTH_USE_HTTPS=True
THIS_APP_SHORTNAME='BBM'
AUTH_SECRET_KEY ='(M)^,+9fs/$-{<I2-8/_-M)Q}e$GrGBf(x|o^wXvy1W{M-LieGB;SO2+&ht_Xo>X'
...
#SYNC_PERMISSIONS_URL='https://lasapp.polito.it/las/syncPermissions/'
APPNAME='tissue'
USE_GRAPH_DB = False
GRAPH_DB_URL=''
