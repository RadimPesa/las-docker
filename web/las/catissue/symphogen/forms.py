...
class CollectionSymForm(forms.Form):  
    def __init__(self, *args, **kwargs):
        super(CollectionSymForm, self).__init__(*args, **kwargs)
        
        lisposti=carica_posti_collez('Symphogen')
        self.fields['Place'] = forms.ChoiceField(label='Place',choices=lisposti)
