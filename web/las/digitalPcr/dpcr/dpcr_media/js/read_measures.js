...
function generate_table(){
    ...
    "aaSorting": [[0, 'asc']],
    "aoColumnDefs": [
        { "bVisible": false, "aTargets": [ 1,3,9,11] },
        ],
    "aLengthMenu": [
        [10, 50, 100, 200, -1],
        [10, 50, 100, 200, "All"]
    ...
    "oTableTools": {
            ...
            , "print"],
            "sSwfPath": base_url + "/dpcr_media/js/DataTables-1.9.4/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
    },
...
function readTable(){
    ...
    jQuery.each(data, function(key, d) { 
        aliquots.push({'aliquotid':d[1], 'value':d[8], 'mtype':d[9]});
    });
