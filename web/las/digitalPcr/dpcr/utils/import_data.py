import sys
sys.path.append('/home/alessandro/LAS/digitalpcrManager/trunk/digitalpcr/')
#sys.path.append('/srv/www/digitalpcr/')
from django.core.management import setup_environ 
import digitalpcr.settings 
setup_environ(digitalpcr.settings)
import shutil
import argparse
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description='Load digitalpcr experiments')
    parser.add_argument('--ifolder', type=str, help='Input folder with digitalpcr experiments')
