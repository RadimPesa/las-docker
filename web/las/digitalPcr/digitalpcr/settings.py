# Django settings for digitalpcr project.
from os import path
import os
...
DB_NAME = 'digitalpcr'
DB_USERNAME = 'digitalpcrusr'
DB_PASSWORD = 'digitalpcrpwd2013'
DB_HOST='lasmysql'
...
MEDIA_ROOT = path.join(BASEDIR, 'dpcr/dpcr_media/')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = '/dpcr_media/'
...
TEMP_URL = path.join(BASEDIR,'dpcr/dpcr_media/tmp/')
...
ROOT_URLCONF = 'digitalpcr.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'digitalpcr.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = ('django.core.context_processors.request',
                                ...
                                'dpcr.context_processor.custom_context_processor',
...
CSRF_COOKIE_PATH = '/dpcr'
SESSION_COOKIE_PATH = '/dpcr'
