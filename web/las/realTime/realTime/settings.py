...
DB_NAME = 'realtime'
DB_USERNAME = 'realtimeusr'
DB_PASSWORD = 'realtimepwd2013'
DB_HOST='lasmysql'
...
connect('rtpcr', host=MONGO_HOST, username=MONGO_USERNAME, password=MONGO_PASSWORD, authentication_source='admin')
#connect('rtpcr', host=MONGO_HOST)
...
MEDIA_ROOT = path.join(BASEDIR, 'rtpcr/rtpcr_media/')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = '/rtpcr_media/'
...
TEMP_URL = path.join(BASEDIR,'rtpcr/rtpcr_media/tmp/')
...
TEMPLATE_CONTEXT_PROCESSORS = ('django.core.context_processors.request',
                                ...
                                'rtpcr.context_processor.custom_context_processor',
...
CSRF_COOKIE_PATH = '/realTime'
SESSION_COOKIE_PATH = '/realTime'
