        ...
        jQuery.ajax({
            ...
            success: function(transport) {
                ...
                for (var i=0; i< data['targets'].length; i++){
                    ...
                    jQuery("#targetAssayTab").dataTable().fnAddData([null, data['targets'][i]['uuid'], data['targets'][i]['name'], data['targets'][i]['allele'], data['targets'][i]['alt'], data['targets'][i]['class'], data['targets'][i]['chrom'], data['targets'][i]['start'], data['targets'][i]['end'], data['targets'][i]['strand'] ])
