...
os.environ['DJANGO_SETTINGS_MODULE'] = 'fingerprinting.settings'
...
def application(environ, start_response):
    ...
    fingerprinting.settings.LOGIN_URL = environ['SCRIPT_NAME'] + fingerprinting.settings.LOGIN_URL
    fingerprinting.settings.BASE_URL = environ['SCRIPT_NAME'] 
