...
DB_NAME='lasannotations_jan2016'
...
MEDIA_ROOT = '/srv/www/newAnnotationsManager/media/'
...
TEMP_ROOT = path.join(BASEDIR,'../media/tmp/')
...
THIS_APP_SHORTNAME='AMMN'
AUTH_SECRET_KEY = 'new~f_9+U?Gv Q/~[aGHFjtFctX/Y>-t9zEwymt9<F!>~-Yoz3-{q2uKdtH<FAfa;s<'
...
CSRF_COOKIE_PATH = '/newannotations'
SESSION_COOKIE_PATH = '/newannotations'
...
FUNNEL_LOG_FILE = '/srv/www/newAnnotationsManager/log/funnel-experiments.log'
