        ...
        if request.method=='POST':
                ...
                try:
                    ...
                    for u in userPermsList:
                        ...
                        if User.objects.filter(username=wgOwner).count()==0:
                            ...
                            #owner.save()
                            #owner.save()
                            cu = User(username=dictUser['username'],password='',first_name=dictUser['first_name'],last_name=dictUser['last_name'],is_active=1,email=dictUser['email'])
                            #Cellline_users(username=dictUser['username'],password='',first_name=dictUser['first_name'],last_name=dictUser['last_name'],is_active=1,email=dictUser['email'],is_superuser=0,institution_id = Institution.objects.get(pk=1),cancer_research_group_id = Cancer_research_group.objects.get(pk=1))
                            cu.save()
                            #cu.supervisor_id=User.objects.get(pk=cu.pk)
                            cu.save()
            ...
            for u in userPermsList:
                ...
                try:
                    ...
                    #user.save()
                    cu = User(username=dictUser['username'],password='',first_name=dictUser['first_name'],last_name=dictUser['last_name'],is_active=1,email=dictUser['email'])
                    #Cellline_users(first_name=dictUser['first_name'],last_name=dictUser['last_name'],is_active=1,email=dictUser['email'],username=dictUser['username'],password='',is_superuser=0,institution_id = Institution.objects.get(pk=1),cancer_research_group_id = Cancer_research_group.objects.get(pk=1))
                    cu.save()
                    #cu.supervisor_id=User.objects.get(pk=cu.pk)
                    cu.save()
