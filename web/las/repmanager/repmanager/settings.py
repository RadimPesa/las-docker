# Django settings for repmanager project.
...
DB_NAME = 'repmanager'
DB_USERNAME = 'repmanagerusr'
DB_PASSWORD = 'repmanagerpwd2013'
DB_HOST='lasmysql'
...
connect('repmanager', host=MONGO_HOST, username=MONGO_USERNAME, password=MONGO_PASSWORD, authentication_source='admin')
#connect('repmanager', host=MONGO_HOST)
...
MEDIA_ROOT = path.join(BASEDIR, 'datamanager/datamanager_media/')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = '/datamanager_media/'
...
SECRET_KEY = 'l$@6#80w%)vibob5xs9r(ol5h(=15m@_h_(^1b)&amp;-h#eg2fw@l'
...
MIDDLEWARE_CLASSES = (
    ...
    'datamanager.middleware.AjaxRedirect',
    'global_request_middleware.GlobalRequestMiddleware', 
    'cookieMiddleware.ExtendUserSession',
)

ROOT_URLCONF = 'repmanager.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'repmanager.wsgi.application'
...
CSRF_COOKIE_PATH = '/repmanager'
SESSION_COOKIE_PATH = '/repmanager'
