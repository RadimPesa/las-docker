...
os.environ['DJANGO_SETTINGS_MODULE'] = 'repmanager.settings'
...
def application(environ, start_response):
    ...
    repmanager.settings.LOGIN_URL = environ['SCRIPT_NAME'] + repmanager.settings.LOGIN_URL
    repmanager.settings.BASE_URL = environ['SCRIPT_NAME'] 
