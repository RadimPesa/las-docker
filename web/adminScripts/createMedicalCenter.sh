...
/virtualenvs/venvdj1.4/bin/python -c "import sys; sys.path.append('/adminScripts'); import utils1_4; utils1_4.createSource('$name', 'Hospital', '$internalName')"
echo
/virtualenvs/venvdj1.7/bin/python -c "import sys; sys.path.append('/adminScripts'); import utils1_7; utils1_7.createInstitution('$name', 'Medical Center', '$internalName')"
